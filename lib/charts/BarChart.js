...
var BarChart = _react2.default.createClass({
    ...
    statics: {
        getOptions: function getOptions(props) {
            ...
            if (barType === 'ValueValue') {
                ...
                var _valueAxis = _ref2[1];

                options.domain[_valueAxis] = valueAxisDomain(data, accessors[_valueAxis], axisType[_valueAxis]);
    ...
    onClickBar: function onClickBar(e, d) {
    ...
    renderValueValueBars: function renderValueValueBars() {
        ...
        return _react2.default.createElement(
            ...
            data.map(function (d, i) {
                var _map3 = ['onMouseEnterBar', 'onMouseMoveBar', 'onMouseLeaveBar', 'onClickBar'].map(function (eventName) {
                ...
                return _react2.default.createElement('rect', { className: className, key: key, x: x, y: y, width: width, height: height, onMouseEnter: onMouseEnter, onMouseMove: onMouseMove, onMouseLeave: onMouseLeave, onClick: onClick });
            })
        );
    },
    renderRangeValueBars: function renderRangeValueBars() {
        ...
        return orientation === 'vertical' ? _react2.default.createElement(
            ...
            this.props.data.map(function (d, i) {
                var _map5 = ['onMouseEnterBar', 'onMouseMoveBar', 'onMouseLeaveBar', 'onClickBar'].map(function (eventName) {
                    // partially apply this bar's data point as 2nd callback argument
                    var callback = (0, _util.methodIfFuncProp)(eventName, _this2.props, _this2);
                    return _lodash2.default.isFunction(callback) ? _lodash2.default.partial(callback, _lodash2.default, d) : null;
                });

                var _map6 = _slicedToArray(_map5, 4);
                ...
                return _react2.default.createElement('rect', _extends({
                    ...
                    width: barThickness,
                    height: barLength
                }, { className: className, key: key, onMouseEnter: onMouseEnter, onMouseMove: onMouseMove, onMouseLeave: onMouseLeave, onClick: onClick }));
            })
        ) : _react2.default.createElement(
            'g',
            null,
            this.props.data.map(function (d, i) {
                var _map7 = ['onMouseEnterBar', 'onMouseMoveBar', 'onMouseLeaveBar', 'onClickBar'].map(function (eventName) {
                    // partially apply this bar's data point as 2nd callback argument
                    var callback = (0, _util.methodIfFuncProp)(eventName, _this2.props, _this2);
                    return _lodash2.default.isFunction(callback) ? _lodash2.default.partial(callback, _lodash2.default, d) : null;
                });

                var _map8 = _slicedToArray(_map7, 4);
