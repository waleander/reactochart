...
var BarChart = _react2.default.createClass({
  ...
  propTypes: {
    ...
    getEndValue: _propTypes2.default.object,
    ...
    onMouseEnterBar: _propTypes2.default.func, // A mouse walks into a bar.
    onMouseMoveBar: _propTypes2.default.func, // He is immediately killed by the bartender,
    onMouseLeaveBar: _propTypes2.default.func // who can't risk another "C" rating from the health department.
  },
