...
var CustomPropTypes = {
    ...
    xyObjectOf: function xyObjectOf(type) {
        return _propTypes2.default.oneOfType([type, _propTypes2.default.shape({ x: type, y: type })]);
    },
    axisType: _propTypes2.default.oneOf(['number', 'time', 'ordinal']),
    //DomainType: PropTypes.arrayOf(PropTypes.oneOfType([PropTypes.number, PropTypes.string, PropTypes.instanceOf(Date)])),
    dataArray: _propTypes2.default.arrayOf(_propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.string, _propTypes2.default.instanceOf(Date)])),
    fourDirections: _propTypes2.default.shape({
        top: _propTypes2.default.number,
        bottom: _propTypes2.default.number,
        left: _propTypes2.default.number,
        right: _propTypes2.default.number
    }),
    stringFormatter: _propTypes2.default.oneOfType([_propTypes2.default.func, _propTypes2.default.string])
};
...
var XYPlot = _react2.default.createClass({
    ...
    propTypes: {
        ...
        scaleType: CustomPropTypes.xyObjectOf(_propTypes2.default.scaleType),
        ...
        nice: CustomPropTypes.xyObjectOf(_propTypes2.default.bool),
        // whether or not to invert the axis (ie. put largest numbers on bottom for Y axis, or on left for X)
        invertAxis: CustomPropTypes.xyObjectOf(_propTypes2.default.bool),
        // placement of the axis labels/ticks on the chart
        axisPosition: _propTypes2.default.shape({
            x: _propTypes2.default.oneOf(['top', 'bottom']),
            y: _propTypes2.default.oneOf(['left', 'right'])
        }),

        // approximate # of ticks to include on each axis - 10 is default
        // (actual # may be slightly different, to get nicest intervals)
        tickCount: CustomPropTypes.xyObjectOf(_propTypes2.default.number),
        ...
        // size of axis ticks
        tickLength: CustomPropTypes.xyObjectOf(_propTypes2.default.number),
        ...
        labelPadding: CustomPropTypes.xyObjectOf(_propTypes2.default.number),
        // label to show for null/undefined values
        emptyLabel: _propTypes2.default.string,

        // should we draw axis value labels
        showLabels: CustomPropTypes.xyObjectOf(_propTypes2.default.bool),
        // should we draw the grid lines in the main chart space
        showGrid: CustomPropTypes.xyObjectOf(_propTypes2.default.bool),
        // should we draw the little tick lines along the axis
        showTicks: CustomPropTypes.xyObjectOf(_propTypes2.default.bool),
        // should we draw a line showing where zero is
        showZero: CustomPropTypes.xyObjectOf(_propTypes2.default.bool),

        // label for entire axis, not value labels
        axisLabel: CustomPropTypes.xyObjectOf(_propTypes2.default.string),
        axisLabelAlign: CustomPropTypes.xyObjectOf(_propTypes2.default.shape({
            horizontal: _propTypes2.default.oneOf(['left', 'center', 'right']),
            vertical: _propTypes2.default.oneOf(['top', 'bottom'])
        })),
        axisLabelPadding: CustomPropTypes.xyObjectOf(_propTypes2.default.number),
...
var XAxisLabel = _react2.default.createClass({
    ...
    propTypes: {
        ...
        axisLabelPadding: _propTypes2.default.number,
        valueLabelPadding: _propTypes2.default.number,
        tickLength: _propTypes2.default.number,
        // bounding box of the label
        labelBox: _propTypes2.default.object
    },
    getDefaultProps: function getDefaultProps() {
        return {
...
var ChartAxis = _react2.default.createClass({
    ...
    propTypes: {
        ...
        axisTransform: _propTypes2.default.string,
        ticks: _propTypes2.default.array,
        ...
        labelPadding: _propTypes2.default.number,
        tickLength: _propTypes2.default.number,
